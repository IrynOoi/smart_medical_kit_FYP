...
--
-- Host: localhost:3306
-- Generation Time: May 15, 2026 at 01:52 PM
...
(1, 'DISP-1', 100, '172.20.10.2', '2026-05-15 13:52:41', -54);
...
(9, 3, 1, 1.00, '04 12 * * *', '2026-05-14', NULL, '2026-05-14 22:57:29', '2026-05-15 11:59:05');
...
--
ALTER TABLE `iot_device`
  MODIFY `device_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1790;

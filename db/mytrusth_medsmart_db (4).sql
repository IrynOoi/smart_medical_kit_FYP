...
--
-- Host: localhost:3306
-- Generation Time: May 14, 2026 at 11:00 PM
...
(1, 'DISP-1', 100, '172.20.10.2', '2026-05-14 23:00:26', -55);
...
(2, 3, 'Medication Reminder', 'Time to take your Metformin', 0, '2026-05-05 22:31:02');
...
--
ALTER TABLE `iot_device`
  MODIFY `device_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1126;
